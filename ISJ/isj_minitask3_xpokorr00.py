...
print(funlist[len(funlist) - 1](a) if funlist[len(funlist) - 1].__code__.co_argcount== 1 == 1 else funlist[len(funlist) - 1](a,b))
# for the slice starting with the second function and including the third one

for func in funlist[1:3]:
    print(func(a) if func.__code__.co_argcount== 1 == 1 else func(a,b))
